...
- 240 evaluation metric prompts in total, with 20 dedicated prompts for each metric per scenario (120 relevance prompts and 120 exact match prompts), along with answers and their corresponding judgment (false or correct).
